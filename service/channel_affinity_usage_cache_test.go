...
var channelAffinityStatsTestID atomic.Uint64
...
func TestObserveChannelAffinityUsageCacheByRelayFormat_ClaudeMode(t *testing.T) {
	ruleName := fmt.Sprintf("rule_%d", channelAffinityStatsTestID.Add(1))
	usingGroup := "default"
	keyFP := fmt.Sprintf("fp_%d", channelAffinityStatsTestID.Add(1))
