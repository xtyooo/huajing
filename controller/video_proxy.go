...
func VideoProxy(c *gin.Context) {
	...
	case constant.ChannelTypeOpenAI, constant.ChannelTypeSora, constant.ChannelTypeAnhe, constant.ChannelTypeShafu:
		// 安和、shafu 与 OpenAI/Sora 一样通过上游 content 接口输出视频，必须携带任务提交时选中的渠道密钥。
