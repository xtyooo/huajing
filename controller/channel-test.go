...
func testChannel(ctx context.Context, channel *model.Channel, testUserID int, testModel string, endpointType string, isStream bool) testResult {
	...
	var unsupportedTestChannelTypes = []int{
		...
		constant.ChannelTypeLingjing,
		constant.ChannelTypeKuai,
		constant.ChannelTypeSD0717,
		constant.ChannelTypeWufan,
		constant.ChannelTypeAutoDLH3,
		constant.ChannelTypeDiaomao,
		constant.ChannelTypeShafu,
		constant.ChannelTypeManju,
		constant.ChannelTypeNaonao,
		constant.ChannelTypeManying,
		constant.ChannelTypeWanchen,
		constant.ChannelTypeYaochen,
	}
