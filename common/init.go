...
func initConstantEnv() {
	...
	constant.MaxMediaDownloadMB = GetEnvOrDefault("MAX_MEDIA_DOWNLOAD_MB", 512)
	constant.MediaDownloadTimeoutSeconds = GetEnvOrDefault("MEDIA_DOWNLOAD_TIMEOUT_SECONDS", 300)
