...
export const TYPE_TO_KEY_PROMPT: Record<number, string> = {
  ...
  [CHANNEL_TYPE_SUB2_API]: 'Enter API key for this channel',
  [CHANNEL_TYPE_NEW_API]: 'Enter API key for this channel',
}
