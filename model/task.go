...
type TaskBillingContext struct {
	...
	ImageSizePricing bool               `json:"image_size_pricing,omitempty"` // 是否按图片尺寸档位计费
	ImageSizeTier    string             `json:"image_size_tier,omitempty"`    // 图片尺寸档位（1k/2k/4k）
}
...
func InitTask(platform constant.TaskPlatform, relayInfo *commonRelay.RelayInfo) *Task {
	...
	if relayInfo != nil && relayInfo.ChannelMeta != nil {
		if relayInfo.ChannelMeta.ChannelType == constant.ChannelTypeGemini ||
			...
			relayInfo.ChannelMeta.ChannelType == constant.ChannelTypeAnhe ||
			...
			relayInfo.ChannelMeta.ChannelType == constant.ChannelTypeNaonao ||
			relayInfo.ChannelMeta.ChannelType == constant.ChannelTypeManying {
