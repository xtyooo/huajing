...
import (
	...
	taskdiaomao "github.com/QuantumNous/new-api/relay/channel/task/diaomao"
	...
	taskmanju "github.com/QuantumNous/new-api/relay/channel/task/manju"
	taskmanying "github.com/QuantumNous/new-api/relay/channel/task/manying"
	...
	tasknaonao "github.com/QuantumNous/new-api/relay/channel/task/naonao"
	...
	taskwanchen "github.com/QuantumNous/new-api/relay/channel/task/wanchen"
	taskwufan "github.com/QuantumNous/new-api/relay/channel/task/wufan"
	taskxs "github.com/QuantumNous/new-api/relay/channel/task/xs"
	taskyaochen "github.com/QuantumNous/new-api/relay/channel/task/yaochen"
	taskzhousd "github.com/QuantumNous/new-api/relay/channel/task/zhou_sd"
...
func GetTaskAdaptor(platform constant.TaskPlatform) channel.TaskAdaptor {
	...
	if channelType, err := strconv.ParseInt(string(platform), 10, 64); err == nil {
		...
		case constant.ChannelTypeMuse:
			return &taskmuse.TaskAdaptor{}
		case constant.ChannelTypeMiniMax:
			return &hailuo.TaskAdaptor{}
		case constant.ChannelTypeMeAI:
			return &taskmeai.TaskAdaptor{}
		case constant.ChannelTypeXs:
			return &taskxs.TaskAdaptor{}
		case constant.ChannelTypeHJ:
			return &taskhj.TaskAdaptor{}
		...
		case constant.ChannelTypeWufan:
			return &taskwufan.TaskAdaptor{}
		case constant.ChannelTypeAnhe:
		...
		case constant.ChannelTypeManju:
			return &taskmanju.TaskAdaptor{}
		case constant.ChannelTypeNaonao:
			return &tasknaonao.TaskAdaptor{}
		case constant.ChannelTypeManying:
			return &taskmanying.TaskAdaptor{}
		case constant.ChannelTypeWanchen:
			return &taskwanchen.TaskAdaptor{}
		case constant.ChannelTypeYaochen:
			return &taskyaochen.TaskAdaptor{}
		}
	}
	return nil
}
