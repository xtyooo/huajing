...
type standardRequest struct {
	...
	ReferenceVideosCamel    taskcommon.MediaURLList `json:"referenceVideos,omitempty"`
	...
	ReferenceAudiosCamel    taskcommon.MediaURLList `json:"referenceAudios,omitempty"`
